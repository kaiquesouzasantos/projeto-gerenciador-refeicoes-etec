...
class TelaContagem:
    def __init__(self):
        ...
        # LINHA 2
        customtkinter.CTkButton(
            master=self.frame_1, text='Refeicoes Repetidas', width=200,font=(fonte, 18), fg_color='#424040', hover_color='#424040'
        ).place(x=50, y=60)

        customtkinter.CTkButton(
            master=self.frame_1, text=self.refeicoes_repetidas,width=135, font=(fonte, 18), fg_color='#BAB3B3', hover_color='#BAB3B3', text_color='#424040'
        ).place(x=245, y=60)
        ...
        # COLUNA 2
        customtkinter.CTkButton(
            master=self.frame_1, text= 'Refeicoes Servidas', width=335,font=(fonte, 18), fg_color='#424040', hover_color='#424040'
        ).place(x=415, y=20)

        customtkinter.CTkButton(
            master=self.frame_1, text=self.refeicoes_servidas, width=335, height=120,font=(fonte, 35), fg_color='#BAB3B3', hover_color='#BAB3B3',text_color='#000'
        ).place(x=415, y=50)
